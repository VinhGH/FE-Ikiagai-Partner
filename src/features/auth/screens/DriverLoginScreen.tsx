...
export default function DriverLoginScreen() {
  ...
  const handleLogin = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      loginSuccess(
        'mock_token_driver_123456',
        { id: '1', name: 'Tài xế Nguyễn Văn A', email: 'drivera@ikigai.com', phone, status: 'approved' },
        'driver'
      );
    }, 1500);
  };
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer} keyboardShouldPersistTaps="handled">
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Bắt đầu nhận đơn và gia tăng thu nhập cùng Ikigai</Text>
        </View>
